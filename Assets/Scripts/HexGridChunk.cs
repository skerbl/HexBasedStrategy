...
public class HexGridChunk : MonoBehaviour
{
	...
	public void Refresh()
	{
		// Enable the component to trigger a refresh in LateUpdate.
		enabled = true;
	}
	...
	private void Triangulate(HexCell cell)
	{
		...
		if (!cell.IsUnderwater)
		{
			...
			// No special features in submerged cells for now.
			// Maybe some can exist underwater? Like sunken temples, or ruined castles?
			if (cell.IsSpecial)
			{
	...
	/// <summary>
	/// Creates colored vertices for one triangle in a HexCell, blending colors with its
	/// neighbor along the edge between them.
	/// </summary>
	/// <param name="direction">The direction of the triangle towards the neigbor</param>
	...
	/// <summary>
	/// Triangulates a HexCell's edge fan.
	/// </summary>
	...
	/// <summary>
	/// Triangulates the strip of quads between two cells' edges.
	/// </summary>
	/// <param name="e1"></param>
	/// <param name="w1"></param>
	/// <param name="e2"></param>
	...
	/// <summary>
	/// Triangulates an edge connection between one triangle of a HexCell and its neighboring cell. 
	/// Creates colored vertices for a rectangle bridging the two cells, blending vertex colors in between.
	/// </summary>
	/// <param name="direction">The direction of the triangle towards the neigbor</param>
	/// <param name="cell">The HexCell</param>
	/// <param name="v1">Vertex 1</param>
	/// <param name="e1">Subdivision vertex 1</param>
	/// <param name="e2">Subdivision vertex 2</param>
	...
	/// <summary>
	/// Blends a terraced cell on the left with a cliff cell on the right.
	/// </summary>
	...
	/// <summary>
	/// Blends a cliff cell on the left with a terraced cell on the right.
	/// </summary>
	/// <param name="begin"></param>
	/// <param name="beginCell"></param>
	/// <param name="left"></param>
	...
	/// <summary>
	/// Looking downstream, the UV coordinates are:
	/// U: left 0, right 1
	/// V: back 0, front 1
	/// </summary>
	/// <param name="v1"></param>
	...
	/// <summary>
	/// Produces interpolation factors for roads when determining the triangle size around 
	/// a cell's center. They need to be smaller when there's no road in this direction.
	/// </summary>
	/// <param name="direction"></param>
	/// <param name="cell"></param>
	/// <returns>A Vector2 containing the left and right interpolation factor.</returns>
	...
	void TriangulateRoadAdjacentToRiver(HexDirection direction, HexCell cell, Vector3 center, EdgeVertices e)
	{
		...
		{
			// We're on the outside of the curve
			HexDirection middle;
			if (previousHasRiver)
			{
